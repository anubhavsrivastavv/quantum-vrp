...
#Kerberos  - This method is suggested but it seems to push requests to Dwave Leap Cloud
#bqm = dimod.BinaryQuadraticModel.from_coo(qubo)
#sampler = KerberosSampler()
#sampleset = sampler.sample_qubo(qubo, max_iter = 100, convergence=3)
